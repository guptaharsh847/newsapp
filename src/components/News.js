...
import PropTypes from 'prop-types'
  ...
  articles=[]
      ...
      handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ee259c7ea6fe43a2b759bf6f40064d3a&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
      ...
      async componentDidMount(){
          let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ee259c7ea6fe43a2b759bf6f40064d3a&page=1&pageSize=${this.props.pageSize}`
          this.setState({loading: true})
          let data=await fetch(url);
